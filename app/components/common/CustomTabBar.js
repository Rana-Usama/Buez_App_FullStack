    ...
    >
      ...
      <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", width: "90%" }}>
        <View style={{ position: "absolute", left: RFPercentage(2.1), justifyContent: "center", alignItems: "center", flexDirection: "row" }}>
          {/* Orders */}
          <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate("MyRequests")} style={{ justifyContent: "center", alignItems: "center" }}>
            <Image
          ...
          {/* Settings */}
          <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate("PostRequest")} style={{ marginLeft: RFPercentage(4), justifyContent: "center", alignItems: "center" }}>
            <Image
              style={{ width: RFPercentage(2.9), height: RFPercentage(2.9) }}
        ...
        <View style={{ position: "absolute", right: RFPercentage(1), justifyContent: "center", alignItems: "center", flexDirection: "row" }}>
          {/* Vehicle */}
          <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate("Messages")} style={{ marginLeft: RFPercentage(4), justifyContent: "center", alignItems: "center" }}>
            <Image
              style={{ width: RFPercentage(2.9), height: RFPercentage(2.9) }}
          ...
          {/* Profile */}
          <TouchableOpacity activeOpacity={0.8} onPress={() => navigation.navigate("Settings")} style={{ marginLeft: RFPercentage(4), justifyContent: "center", alignItems: "center" }}>
            <Image
              style={{ width: RFPercentage(2.9), height: RFPercentage(2.9) }}
