// Validate name
export const validateName = (name : any, minLength = 3) => {
	if (!name) {
...
export const validatePassword = (password : any, minLength = 6) => {
	if (/\s/.test(password)) {
...
export const validateConfirmPassword = (password : any, confirmPassword:any) => {
