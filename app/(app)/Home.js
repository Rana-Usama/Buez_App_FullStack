      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollViewContent}>
        ...
        {taskRecords.map((cart, cartIndex) => (
          <View activeOpacity={0.8} key={cartIndex} style={[styles.cartContainer, { marginTop: cartIndex === 1 ? RFPercentage(3) : RFPercentage(2) }]}>
            ...
            {/* Info */}
            <TouchableOpacity activeOpacity={0.8} onPress={() => router.push({pathname: '/OfferDetail', params: {postRequest: cart.id}})} style={styles.cartInfoContainer}>
            ...
            <TouchableOpacity activeOpacity={0.8} onPress={() => router.push({ pathname: '/OfferDetail', params: { postRequest: cart.id } })} style={styles.taskInfoContainer}>
